...
public class NewClass {
    ...
    public String checkDate(String year,String month,String day){
        ...
        try{
            ...
            if(monthValid>12||monthValid<1) throw new RuntimeException("Month is out of range");
        ...
        try{
            ...
            if(dayValid<1||dayValid>31) throw new RuntimeException("Day is out of range");
        }catch(RuntimeException ex){
            return ex.getMessage();
        }catch(Exception e){
        ...
        try{
            ...
            if(yearValid<1000||yearValid>5000) throw new RuntimeException("Year is out of range");
        }catch(RuntimeException ex){
            return ex.getMessage();
        }catch(Exception e){
